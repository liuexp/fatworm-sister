...
import fatworm.sister.sqlcli.FatwormSqlClient;
...
public class Launcher {
	...
	private static String url = "jdbc:fatworm://your.db";
	...
	private static Options getOptions() {
		...
		ops.addOption("o", "output", true, "The path of file to dump all output");
	...
	private static void launch() {
		SqlClient client = new FatwormSqlClient();
		client.connect(url);
